...
main(int argc, char *argv[])
{
    ...
    //TODO: northd acquires a lock at this point - should we do this here ???????
                ...
                if (ovs_idl_txn) {
                    if (ofctrl_can_put()) {
                        ...
                        lflow_run(
                            ...
                            &flow_table, &group_table, &meter_table); //TODO?????????????????
