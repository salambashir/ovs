...
const struct nbrec_sb_chassis *chassis_lookup_by_name(
    struct ovsdb_idl_index *nbrec_sb_chassis_by_name, const char *name);

const struct nbrec_sb_chassis *nb_chassis_lookup_by_name(
    struct ovsdb_idl_index *nbrec_sb_chassis_by_name, const char *name); //Salam
